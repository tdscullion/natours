...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      // validate: [validator.isAlpha, 'Tour names can only contain letters'],
    },
    slug: String,
    duration: {
      type: Number,
    ...
    ratingsAverage: {
      ...
      max: [5, 'A rating must be 5.0 or below'],
...
// DOCUMENT MIDDLEWARE - Runs before .save() and .create() will not run on others!!! //
