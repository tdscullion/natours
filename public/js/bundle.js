...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGRzY3VsbGlvbiIsImEiOiJja2VsaGNsaHUycWVmMnNsdGo1NDNyandvIn0.xpwiB1FBc1PyFRR3CUisOA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/tdscullion/ckeq8jrtc5ltm19qqhsqv6vjd',
    scrollZoom: false // center: [-118.238148, 33.98023],
    // zoom: 8,
    // interactive: false,
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // Add popup to map
...
var stripe = Stripe('pk_test_51HTnBwFdrNtowPBaMVxk5CwakePtKwLOzT9Twha8a2t6Fb4RQOIfhmxwWu15Acji5cIE1q9ltuL4SbVQqmSNMp6W00qpthqRde');
